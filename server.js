...
function defaultPacks() {
  ...
  return {
    red: pack([
      ["DRIVING FAST SAVES SECONDS BUT CAN COST LIVES", "FAST DECISIONS AT RED CAN LEAD TO LIFELONG REGRETS"],
      ["RUNNING A RED LIGHT AT FAST SPEED RISKS LIVES", "STOP TODAY SO YOU CAN DRIVE TOMORROW"],
      ["SPEED AT RED CAN CHANGE MANY LIVES FOREVER", "RESPECT THE RED LIGHT RESPECT LIFE"],
      ["FAST DRIVERS REACH DANGER FIRST", "STOPPING NOW PREVENTS REGRET LATER"],
      ["RED LIGHT IS A WARNING NOT A CHALLENGE", "SLOW DOWN AND SAVE LIVES"],
    ]),

    amber: pack([
      ["DRIVING FAST AT AMBER INCREASES ACCIDENT RISK", "SLOW DOWN BEFORE SPEED HARMS"],
      ["AMBER LIGHT IS A WARNING NOT A RACE SIGNAL", "THINK BEFORE YOU SPEED"],
      ["RUSHING AT YELLOW OFTEN LEADS TO RED REGRETS", "PAUSE THE HURRY DRIVE SAFELY"],
      ["ACCELERATING AT YELLOW INVITES ACCIDENTS", "CALM YOUR ACCELERATOR"],
      ["SLOWING AT AMBER PROTECTS EVERY LIFE", "CAUTION TODAY SAFETY TOMORROW"],
    ]),

    green: pack([
      ["GREEN MEANS GO BUT NOT GO FAST", "DRIVE RESPONSIBLY"],
      ["FAST DRIVING IMPRESSES NONE BUT ENDANGERS ALL", "MOVE SAFE NOT FAST"],
      ["GO AHEAD SAFELY THE ROAD IS SHARED", "RESPECT EVERY LIFE ON THE ROAD"],
      ["SPEED THRILLS BUT SAFETY SAVES", "SAFE DRIVING IS SMART DRIVING"],
      ["GREEN GIVES WAY NOT PERMISSION TO SPEED", "ARRIVE SAFE EVERY TIME"],
    ]),
